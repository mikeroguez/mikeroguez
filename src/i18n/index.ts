...
export interface Messages {
  ...
  work: {
    ...
    conacytSeedProgram: string;
    conacytSeedProgramContext: string;
    conacytSeedProgramLabel: string;
    conacytSeedPeriod: string;
    ...
    pronacesDesc: string;
    pronacesProgram: string;
    pronacesProgramContext: string;
    pronacesProgramLabel: string;
    pronacesPeriod: string;
