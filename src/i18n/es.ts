...
export default {
  ...
  work: {
    ...
    conacytSeedProgramContext: 'Proyecto semilla',
    conacytSeedProgramLabel: 'Proyecto semilla con financiamiento CONACYT',
    conacytSeedPeriod: '2020-2021',
    conacytSeedTagsLabel: 'Ejes del proyecto semilla CONACYT',
    conacytSeedTag1: 'Lectoescritura',
    conacytSeedTag2: 'Educación básica',
